...
## Network security
- [ ] Find a reputable VPN service with a laptop & mobile phone client to use for hostile networks (e.g. unencrypted wifi) or as an everyday privacy guard. [This site](https://thatoneprivacysite.net/vpn-section/) has a great deal of information on different options for VPN providers. Of the providers listed there, [Private Internet Access](https://www.privateinternetaccess.com) is a very good option, and relatively well priced, and provide clients for every major OS, and for android/mac as well.
